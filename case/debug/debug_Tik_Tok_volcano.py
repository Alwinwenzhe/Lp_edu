...
# 抖音 com.ss.android.ugc.live    com.ss.android.ugc.live.main.MainActivity
...
def get_driver():
    capabilities ={
        ...
        "appActivity" : "com.ss.android.ugc.live.main.MainActivity",        #appium1.7版本之后就应该不需要改配置了;这里报错很多次，因为activity名字错误，aapt检查出来
